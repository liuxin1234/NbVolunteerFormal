...
public class ApplyMajorAbilityActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if (Build.VERSION.SDK_INT >= 23) {
                    if (ContextCompat.checkSelfPermission(ApplyMajorAbilityActivity.this,
                        ...
                        if (!ActivityCompat.shouldShowRequestPermissionRationale(ApplyMajorAbilityActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                            showMessageOKCancel("您需要在应用权限设置中对本应用读写SD卡进行授权才能正常使用该功能",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            ActivityCompat.requestPermissions(ApplyMajorAbilityActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                        ...
                        ActivityCompat.requestPermissions(ApplyMajorAbilityActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},
                                READ_EXTERNAL_STORAGE_REQUEST_CODE);
                        return;
                    } else if (ContextCompat.checkSelfPermission(ApplyMajorAbilityActivity.this,
                            Manifest.permission.CAMERA)
                            != PackageManager.PERMISSION_GRANTED) {
                        if (!ActivityCompat.shouldShowRequestPermissionRationale(ApplyMajorAbilityActivity.this, Manifest.permission.CAMERA)) {
                            showMessageOKCancel("您需要在应用权限设置中对本应用使用摄像头进行授权才能正常使用该功能",
                                    new DialogInterface.OnClickListener() {
                                        @Override
                                        public void onClick(DialogInterface dialog, int which) {
                                            ActivityCompat.requestPermissions(ApplyMajorAbilityActivity.this, new String[]{Manifest.permission.CAMERA},
        ...
        list_show.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                intent.setClass(ApplyMajorAbilityActivity.this, Delete_certificate.class);
    ...
    public void get_pic() {
        Intent intent = new Intent(ApplyMajorAbilityActivity.this, MultiImageSelectorActivity.class);
        // 是否显示调用相机拍照
