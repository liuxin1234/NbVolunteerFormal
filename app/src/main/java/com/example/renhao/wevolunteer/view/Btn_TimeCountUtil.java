...
/*
 *
 * Created by Ge on 2016/8/11  14:46.
 *
 */
...
public class Btn_TimeCountUtil extends CountDownTimer {
    ...
    public Btn_TimeCountUtil(Activity mActivity, long millisInFuture, long countDownInterval, Button btn) {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        //设置按钮为灰色，这时是不能点击的
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.verify_seleted_btn));
    ...
    public void onFinish() {
        ...
        btn.setBackground(mActivity.getResources().getDrawable(R.drawable.verify_common_btn));//还原背景色
    }
