...
import com.example.renhao.wevolunteer.view.AutoRadioGroup;
...
public class ProjectActivity extends BaseActivity implements RadioGroup.OnCheckedChangeListener,
    ...
    private void initActionbar() {
        ...
        switchGroup = (AutoRadioGroup) mCustomView.findViewById(R.id.radiogroup_project_projectswitch);
