...
public class AutoLinearLayout extends LinearLayout {
    ...
    @Override
    public com.zhy.autolayout.AutoLinearLayout.LayoutParams generateLayoutParams(AttributeSet attrs)
    {
        return new com.zhy.autolayout.AutoLinearLayout.LayoutParams(getContext(), attrs);
    }
